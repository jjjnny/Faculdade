...
public class MathServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Adição</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
             ...
             switch (op) {
                 case 1:
                out.println("<h1>Adição</h1>");
                out.println("<hr>");
                out.println("<h2>"+n1+" + "+n2+" + "+n3+" = "+(n1+n2+n3)+"</h2>");
                break;
                ...
                break;
                 case 4:
                out.println("<h1>Multiplicação</h1>");
                out.println("<hr>");
                out.println("<h2>"+n1+" x "+n2+" x "+n3+" = "+(n1*n2*n3)+"</h2>");
                break;
            }
